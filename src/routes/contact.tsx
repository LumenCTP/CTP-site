...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with ClearToPay Construction — support, sales, and vendor document submissions." },
    ],
  }),
  component: Contact,
});
...
function ContactCard({ icon, title, children }: { icon: ReactNode; title: string; children: ReactNode }) {
  return (
    <div className="card-lift rounded-2xl border border-slate-200/60 bg-white p-8 shadow-sm">
      ...
      <h2 className="text-lg font-bold tracking-[-0.01em] text-slate-900">{title}</h2>
    ...
    <PageShell>
      ...
      <section className="relative overflow-hidden border-b border-slate-100 bg-gradient-to-b from-blue-50/60 via-white to-white py-16 sm:py-20">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600">Contact</span>
          <h1 className="mt-4 text-4xl font-extrabold tracking-[-0.02em] text-slate-900 sm:text-5xl">
            We'd love to hear from you
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-slate-500">
            Questions about compliance, your reports, or getting started? Reach out — a real person on our
      ...
      <main className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <ContactCard icon={<IconShield />} title="Submit Compliance Documents">
            <p>
              Vendors and insurance agents can email certificates of insurance, W-9s, and other compliance
              documents directly to our secure compliance inbox at{" "}
              <a href={`mailto:${COMPLIANCE_INBOX}`} className="break-all font-semibold text-blue-600 hover:underline">
                {COMPLIANCE_INBOX}
              </a>
              . Documents are processed automatically and attached to the right vendor.
            </p>
          </ContactCard>
          ...
          <ContactCard icon={<IconChat />} title="Sales &amp; Getting Started">
            <p>
              ...
              <a href="/get-started" className="font-semibold text-blue-600 hover:underline">
                Start your free trial
              </a>{" "}
              — your first month is free, set up takes about an hour, and you can cancel anytime.
            </p>
          </ContactCard>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-3xl rounded-2xl border border-blue-100 bg-blue-50/70 p-8 text-center sm:p-10">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-slate-600">
            Send us your vendor list and we'll show you exactly what your Monday Clear-to-Pay Report would
            look like — before you sign up for anything.
          </p>
          <a
            href="/get-started"
