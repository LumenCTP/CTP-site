  ...
  return (
    <div className="min-h-dvh bg-white text-slate-900 font-sans">
      ...
      <section id="pricing" className="relative py-28 sm:py-36 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center animate-on-scroll">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600">Pricing</span>
            <h2 className="mt-4 text-4xl font-extrabold tracking-[-0.02em] text-slate-900 sm:text-5xl sm:tracking-[-0.025em]">
              Simple pricing. Serious protection.
            </h2>
            <p className="mt-6 text-lg leading-relaxed text-slate-500">
              Everything you need to keep every vendor compliant — no per-vendor fees, no hidden costs.
            </p>
          </div>
          ...
          <div className="mx-auto mt-24 grid max-w-5xl items-stretch gap-8 lg:grid-cols-2">
            ...
            <div className="card-lift flex flex-col rounded-2xl border border-slate-200/60 bg-white p-10 shadow-sm">
              ...
              <a href="/get-started" className="mt-10 inline-flex justify-center rounded-xl border border-slate-200 bg-white px-6 py-3.5 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:border-blue-300 hover:text-blue-600">
            ...
            <div className="card-lift relative flex flex-col rounded-2xl border-2 border-blue-600 bg-white p-10 pt-12 shadow-xl shadow-blue-600/15 lg:scale-[1.03]">
              ...
              <div className="mt-6 space-y-1.5">
                ...
                <p className="text-sm font-bold text-blue-600">Save $360/year</p>
              </div>
              <ul className="mt-8 flex-1 space-y-3.5 text-sm text-slate-600">
                {pricingFeatures.map((f) => (
                  <li key={f} className="flex items-start gap-3">
              ...
              <a href="/get-started" className="btn-glow mt-10 inline-flex justify-center rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-semibold text-white shadow-md shadow-blue-600/25 transition-all hover:bg-blue-700">
                Start Your Free Month
              </a>
            </div>
          </div>
